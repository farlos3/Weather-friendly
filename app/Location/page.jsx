    ...
    <div className="flex min-h-screen bg-gradient-to-b from-[#0A144A] to-[#1A294E] text-white">
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex justify-center items-center mt-8">
          <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-4xl p-4 text-black">
            <div className="relative h-96 bg-gray-200 rounded-lg overflow-hidden">
              ...
              <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 bg-white p-4 rounded-lg shadow-md text-center">
                ...
                <button className="mt-2 bg-yellow-400 px-4 py-2 rounded-lg text-white font-semibold">
            ...
            <div className="flex justify-center mt-4">
              <button className="bg-[#2C3E75] px-6 py-3 rounded-full text-white font-semibold">
                ดูข้อมูลสภาพอากาศ
              </button>
            </div>
          </div>
