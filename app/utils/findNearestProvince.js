...
export function findNearestProvince(userLat, userLon) {
    ...
    provinces.forEach((province) => {
        ...
        if (distance < minDistance) {
            ...
            nearestProvince = province; // เก็บทั้ง object ของ province
        }
    });

    // คืนค่าชื่อจังหวัดและภูมิภาค
    return nearestProvince
        ? { name: nearestProvince.name, region: nearestProvince.region }
        : null;
}